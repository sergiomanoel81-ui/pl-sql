...
-- 3 - DESATIVAR CONSTRAINT DO SALDO FECHADO E REABRIR

ALTER TRIGGER TASY.MOVTO_TRANS_FINANC_DELETE DISABLE;
ALTER TRIGGER TASY.MOVTO_TRANS_FINANC_DELETE ENABLE;
